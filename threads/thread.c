...
init_thread (struct thread *t, const char *name, int priority)
{
  ...
  //INITIALIZE SEMAPHORE IF ONE DOWN IT WILL GO TO SLEEP
  sema_init (&t->c_sema, 0);
  sema_init (&t->p_sema, 0);

  //INITIALIZE THE thread_cur_fd_index to 0
  t->thread_cur_fd_index = 0;
...
/* find the thread from all threads list */
struct thread *
